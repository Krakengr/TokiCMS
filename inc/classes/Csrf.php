...
class Csrf {
    ...
    private static function setToken($token)
    {
		...
		//Passing null to unserialize is deprecated
        $tokenList = ( ( !isset( $_SESSION['X-CSRF-TOKEN-LIST'] ) || is_null( $_SESSION['X-CSRF-TOKEN-LIST'] ) ) ? null : unserialize( $_SESSION['X-CSRF-TOKEN-LIST'] ) );
